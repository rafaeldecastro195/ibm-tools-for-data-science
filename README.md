# ibm-tools-for-data-science
 ...
 ## Sobre:
Projeto final do curso [Tools for Data Science](https://www.coursera.org/learn/open-source-tools-for-data-science?specialization=ibm-data-science) da IBM, oferecido na plataforma da Coursera. Este curso é o segundo da Especialização de Certificação Profissional [IBM Data Science](https://www.coursera.org/professional-certificates/ibm-data-science). 

O foco do curso são a apresentação sobre ferramentas populares para Ciência de Dados, tais como: linguagens, bibilotecas e frameworks, IDEs, notebooks e toolkits.
...
| Markdown | Python |
| :---: | :---: |
| Listas Ordenadadas | Uso de Variáveis |
| Listas Não ordenadas | Cálculos Aritméticos básicos |
| Tabelas | f-strings |
